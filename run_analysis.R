...
## What I think I have to do here is to attach cbind(X_test,X_train) and also cbind(y_test,y_train)
...
tidy1 <- cbind(ymerge,Xmerge) # Base de datos que contiene las variables independientes y los features
...
View(tidy5)
write.table(tidy5,file="./Desktop/TidyDataSet.txt",row.name=FALSE)
